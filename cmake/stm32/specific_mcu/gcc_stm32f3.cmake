set(CHIP_C_OPTIONS -g3 -mthumb -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -std=gnu99 -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize -Wl,-Map,output.map CACHE INTERNAL "c compiler flags")
set(CHIP_CXX_OPTIONS -g3 -mthumb -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize -Wl,-Map,output.map CACHE INTERNAL "cxx compiler flags ")
set(CHIP_ASM_OPTIONS -g3 -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -Wa,--no-warn -x assembler-with-cpp CACHE INTERNAL "asm compiler flags")
set(CHIP_EXE_LINK_OPTIONS -Wl,--gc-sections -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -specs=nosys.specs CACHE INTERNAL "executable linker flags")
set(CHIP_MODULE_LINKER_OPTIONS -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 CACHE INTERNAL "module linker flags")
set(CHIP_SHARED_LINKER_OPTIONS -mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 CACHE INTERNAL "shared linker flags")
