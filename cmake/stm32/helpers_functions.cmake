...
FUNCTION(PRINT_SIZE_OF_TARGET EXECUTABLE_NAME)
    ...
    add_custom_command(TARGET ${EXECUTABLE_NAME} WORKING_DIRECTORY ${PATH_TO_SIZE_UTILITY} POST_BUILD COMMAND ${PATH_TO_SIZE_UTILITY}/print_size.cmd ${BUILD_DIR}/size.txt ${FLASH_SIZE_FULL} ${RAM_SIZE_FULL})
ENDFUNCTION()
